 ...
 * Hero images: Unsplash (https://unsplash.com/license) — illustrative only, not clinical outcomes.
 */
...
export const WELLNEST_RECOMMENDER_DEFAULT_IMAGE = unsplash(
...
const RECOMMENDER_IMAGE_BY_TREATMENT: Record<string, string> = {
  ...
  [nk("Ipamorelin")]: unsplash("photo-1541788420466-64809e9217c6"),
  ...
  [nk("Pinealon")]: unsplash("photo-1515377902966-de22c22b1a27"),
